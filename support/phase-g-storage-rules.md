...
(qualification and release) is in progress: CI, consumer cheap gates, Mac
journeys and a Linux no-Java smoke are done, the paired acceptance and the
release are deferred to the joint pre-release smoke. Receipts, all on that
branch:
