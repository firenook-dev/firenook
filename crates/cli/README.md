...
This package contains the single `firenook` emulator-suite binary. The
`firenook firestore` subcommand starts the current Firestore-compatible gRPC,
...
live cache counters at `GET /emulator/v1/debug/memory`. Firenook deliberately
