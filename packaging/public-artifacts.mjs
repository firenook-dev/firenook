...
const cliFiles = ['LICENSE-APACHE', 'LICENSE-MIT', 'README.md', 'package.json', 'release.json',
  'bin/fireside.mjs', 'src/assets.mjs', 'src/binary.mjs', 'src/firestore-values.mjs', 'src/hub.mjs', 'src/init.mjs', 'src/invoke.mjs', 'src/options.mjs', 'src/processes.mjs', 'src/rc.mjs', 'src/runtime.mjs'];
