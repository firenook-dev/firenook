---
name: kumo-design
description: Design rules for interfaces built with Kumo, the Cloudflare component library the Firenook console uses. Use when designing, implementing or reviewing console screens, responsive styling, dialogs or frontend tests under console/.
---

> Vendored from cloudflare/kumo `skills/kumo-design/SKILL.md` at commit b3352cab6cb0e637154c92a2f25e61b57bb6c0b4 (MIT, see LICENSE next to this file). The rules below are Kumo's; the console follows them. For component APIs run `npx @cloudflare/kumo doc <Component>`, for the token reference `npx @cloudflare/kumo ai`, and see `reference/ai-guide.md` for the version the console pins.
