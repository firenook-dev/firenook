...
writeFileSync(
  ...
  `# Firenook component library\n\nKumo (Cloudflare's component library, MIT) under the Firenook theme: the ember accent and the IBM Plex type pair. Every card is the real component rendered by a browser, so what the design tool shows is what the console renders.\n\nCards are listed in cards.json; each page starts with an @dsCard marker. Fonts are under fonts/ and referenced relatively.\n\nGenerated by console/scripts/design-system/build.mjs. Do not edit by hand.\n`,
)
if (errors.length) {
