...
These are Kumo's own rules (MIT, from cloudflare/kumo `skills/kumo-design`). The Firenook console follows them as written; "Cloudflare product interfaces" reads as "the Firenook console".
